...
def voice_check(member: discord.Member, existing_player) -> Optional[str]:
    """
...
def voice_check_or_raise(member: discord.Member, existing_player) -> Tuple[discord.VoiceChannel, object]:
