      ...
      <div className="glass relative mx-4 w-full max-w-md rounded-2xl border border-white/10 p-6 shadow-2xl">
        ...
        <div className="space-y-4">
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full rounded-lg border border-white/10 bg-dark-800/50 px-3 py-2.5 pr-10 text-sm text-white placeholder:text-dark-500 focus:border-accent-violet/50 focus:outline-none focus:ring-1 focus:ring-accent-violet/30"
                autoFocus
              />
              <button
                type="button"
          ...
          <button
            ...
            className="w-full rounded-lg bg-accent-violet py-2.5 text-sm font-semibold text-white transition-all hover:bg-accent-violet/80 hover:scale-[1.02] active:scale-95"
          >
            Connect
          </button>
        </div>
